...
public static class OptimizationStateKeys
{
    public const string SafetySettings = "system.optimizations.safety-settings";
    public const string LastGameBoosterSession = "jb-gamebooster.last-session";
